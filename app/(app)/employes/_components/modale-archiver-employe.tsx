...
interface ModaleArchiverEmployeProps {
  ouvert: boolean;
  onClose: () => void;
  employeId: string;
  employeNom: string;
...
export function ModaleArchiverEmploye({
  ouvert,
  onClose,
  employeId,
  employeNom,
  employePrenom,
}: ModaleArchiverEmployeProps) {
          ...
          <div className="space-y-4">
            ...
            <div className="space-y-2">
              ...
              <Input
                ...
                placeholder="Ex: Fin de contrat, démission, licenciement, retraite..."
