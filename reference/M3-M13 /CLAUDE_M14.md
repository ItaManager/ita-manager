...
| 3 | `PATRONS.md` | Patrons et règles R-01 à R-07 |
| 4 | `TYPOGRAPHIE.md` | Police, échelle, graisses, couleurs, icônes |
| 5 | `CHAMPS.md` | États des champs, autocomplétation, modales |
| 6 | `GUIDE-ENVIRONNEMENTS.md` | Branches, base, déploiement |

### Dossiers de module

`M0-SOCLE.md` · `M1-ORGANISATION.md` · `M2-EMPLOYES.md` · `M3-CONGES.md` ·
`M4-REMUNERATION.md` · `M5-PROJETS.md` · `M6-RELEVES.md` ·
`M7-PAIE-CHANTIER.md` · `M8-M12-DOSSIERS.md` · `M14-ACHATS.md`

Ne lis que celui du module en cours.

### Références visuelles — `reference/`

Aperçus autonomes : styles en ligne, aucune dépendance shadcn.

**Ce sont des références, pas du code à intégrer.** Ne les fais pas compiler.
Ils donnent la densité, les espacements et la formulation exacte des libellés
et des textes d'aide.
...
**R-05** · Étapes pour créer, onglets pour modifier. Les jetons de la modale
sont verrouillés — champs en `rounded-md`, jamais `lg` ni `xl`.

**R-06** · Les jetons typographiques sont verrouillés. `TYPOGRAPHIE.md` fait
foi : Inter avec `tabular-nums`, quatre paliers de taille, trois graisses,
jamais `font-bold`. Neuf interdits, quatre commandes de vérification.

**R-07** · Les états des champs sont spécifiés. `CHAMPS.md` fait foi : sept
états de champ, comportement de l'autocomplétation, structure des modales.
L'erreur remplace l'aide et n'apparaît qu'au `blur`. Une option verrouillée
s'affiche désactivée avec sa raison, jamais masquée.
